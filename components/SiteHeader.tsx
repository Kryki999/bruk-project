      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Link
              ...
              className={`text-2xl font-bold transition-colors duration-300 ${
                showSolidBackground ? "text-white" : "text-white/90"
              }`}
            >
              DAVIX
            </Link>
          ...
          <div className="flex items-center space-x-3">
            ...
            <a href="tel:+48514255516" className="shrink-0">
              <Button
                size="sm"
            ...
            <button
              className={`md:hidden inline-flex items-center justify-center rounded-md p-2 focus:outline-none focus:ring-2 transition-colors ${
                showSolidBackground
